...
export const InputAmount: React.FC<InputProps> = ({className, ...props}) =>  {
    return <section className="flex items-center justify-center gap-2">
                ...
                <input type="text" className={cn("bg-Branding-input border border-Branding-textAccent w-[3.5rem] h-[2.625rem] rounded-[0.5rem] font-inter text-[1rem] leading-[1.1875rem] text-white text-center px-2 py-1 focus:outline-none", className)} {...props}/>
            </section>
};
