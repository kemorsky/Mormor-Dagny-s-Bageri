...
export const InputAmount: React.FC<InputProps> = ({className, ...props}) =>  {
    return <input type="text" className={cn("bg-white w-[3.25rem] h-[2.625rem] rounded-[0.5rem] text-[1rem] text-black text-center px-2 py-1 focus:outline-none", className)} {...props}/>
}
