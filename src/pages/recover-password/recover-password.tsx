                ...
                <div className="absolute inset-0 top-[8.125rem] flex flex-col items-start justify-start gap-6">
                    <div className="px-[1.375rem]">
                        <article className="flex flex-col gap-3">
                            <h1 className="font-open-sans font-bold text-[2rem] leading-[2.75rem] text-Branding-textPrimary">Glömde ditt lösenord?</h1>
                            <p className="w-[19.1875rem] font-open-sans font-semibold text-Branding-textSecondary text-[1.375rem] leading-[1.875rem]">Vi löser det direkt.</p>
                        </article>
                    </div>
